...
CREATE DATABASE HLTWK11OlaoluAkomolafe;

-- ACCESS/SELECT THE DATABASE FOR TABLE CREATION
USE HLTWK11OlaoluAkomolafe;

-- CREATE customers Table under HLTWK11OlaoluAkomolafe and DECLARE Fields Data Types
...
-- SELECT ALL CUSTOMERS RECORDS IN THE DATABASE

SELECT * 
FROM customers;

-- EXAMPLE 2 --- QUERY THE DATABASE
-- SELECT ALL CUSTOMERS WHOSE COUNTRY IS FRANCE
...
-- SELECT ALL CUSTOMERS on EVEN ROWS

SELECT * 
FROM customers
WHERE mod (customer_id,2)= 0;

-- EXAMPLE 4 --- QUERY THE DATABASE
-- SELECT ALL CUSTOMERS WHOSE Name begins with A or B and ends with S or R

SELECT * 
FROM customers
WHERE customer_name REGEXP '^[AB].*[SR]$'
